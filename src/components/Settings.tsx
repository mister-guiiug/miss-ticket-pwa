...
import { ArrowLeft, Settings as SettingsIcon, Bell, Palette, Shield, Info, Trash2, ChevronRight, Moon, Sun, Zap } from 'lucide-react';
import { applyTheme } from '../styles/theme';
import { useOnline } from '../hooks/useWindowSize';
      ...
      <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
        ...
        <Section title="Apparence" icon={<Palette size={18} />}>
          <SettingItem
            icon={<div style={{
              ...
              height: '40px',
              borderRadius: '10px',
              backgroundColor: settings.theme === 'dark' ? 'var(--bg-tertiary)' : 'var(--warning-bg)',
              display: 'flex',
              alignItems: 'center',
              justifyContent: 'center',
            }}>
            ...
            description={settings.theme === 'dark' ? 'Mode sombre activé' : 'Mode clair activé'}
            action={
              <button
        ...
        <Section title="Notifications" icon={<Bell size={18} />}>
          <SelectSetting
            ...
            onChange={(value) => updateSetting('notifications', value as NotificationPreference)}
...
function SettingItem({ icon, label, value, description, action }: SettingItemProps) {
  return (
    <div style={{
      display: 'flex',
      alignItems: 'center',
...
function ToggleSetting({ icon, label, checked, onChange, description }: ToggleSettingProps) {
  return (
    <div style={{
      display: 'flex',
      alignItems: 'center',
      ...
      <button
        ...
        style={{
          ...
          width: '48px',
          height: '28px',
          backgroundColor: checked ? 'var(--primary-500)' : 'var(--bg-tertiary)',
          border: 'none',
          borderRadius: '14px',
          cursor: 'pointer',
          transition: 'all 0.2s',
...
function SelectSetting({ icon, label, value, options, onChange, description }: SelectSettingProps) {
              ...
              {options.map((option) => (
                <button
                  ...
                  style={{
                    ...
                    border: 'none',
                    color: value === option.value ? 'var(--primary-500)' : 'var(--text-primary)',
                    cursor: 'pointer',
                    fontSize: '14px',
